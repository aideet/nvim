...
map('', '<leader>ha', '<CMD>HopAnywhere<CR>', { silent = true, noremap = true, desc = "anywhere" })
map('', '<leader>hw', '<CMD>HopWordCurrentLine<CR>', { silent = true, noremap = true, desc = "current line word" })
map('', '<leader>hh', '<CMD>HopWord<CR>', { silent = true, noremap = false, desc = "word" })
map('', '<leader>hc', '<CMD>HopChar1<CR>', { silent = true, noremap = true, desc = "char" })
map('', '<leader>hC', '<CMD>HopCamleCase<CR>', { silent = true, noremap = true, desc = "camel case" })
map('', '<leader>hb', '<CMD>HopChar2<CR>', { silent = true, noremap = true, desc = "bigram" })
map('', '<leader>hl', '<CMD>HopLine<CR>', { silent = true, noremap = true, desc = "line" })
map('', '<leader>hp', '<CMD>HopPattern<CR>', { silent = true, noremap = true, desc = "pattern" })
map('', '<leader>hs', '<CMD>HopNodes<CR>', { silent = true, noremap = true, desc = "Treesitter symbols" })
