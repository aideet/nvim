...
map('v', '<leader>ha', '<CMD>HopAnywhere<CR>', { silent = true, noremap = true, desc = "anywhere" })
map('n', '<leader>hw', '<CMD>HopWordCurrentLine<CR>', { silent = true, noremap = true, desc = "current line word" })
map('v', '<leader>hw', '<CMD>HopWordCurrentLine<CR>', { silent = true, noremap = true, desc = "current line word" })
map('n', '<leader>hh', '<CMD>HopWord<CR>', { silent = true, noremap = true, desc = "word" })
map('v', '<leader>hh', '<CMD>HopWord<CR>', { silent = true, noremap = true, desc = "word" })
map('n', '<leader>hc', '<CMD>HopChar1<CR>', { silent = true, noremap = true, desc = "char" })
map('v', '<leader>hc', '<CMD>HopChar1<CR>', { silent = true, noremap = true, desc = "char" })
map('n', '<leader>hC', '<CMD>HopCamleCase<CR>', { silent = true, noremap = true, desc = "camel case" })
map('v', '<leader>hC', '<CMD>HopCamleCase<CR>', { silent = true, noremap = true, desc = "camel case" })
map('n', '<leader>hb', '<CMD>HopChar2<CR>', { silent = true, noremap = true, desc = "bigram" })
map('v', '<leader>hb', '<CMD>HopChar2<CR>', { silent = true, noremap = true, desc = "bigram" })
map('n', '<leader>hl', '<CMD>HopLine<CR>', { silent = true, noremap = true, desc = "line" })
map('v', '<leader>hl', '<CMD>HopLine<CR>', { silent = true, noremap = true, desc = "line" })
map('n', '<leader>hp', '<CMD>HopPattern<CR>', { silent = true, noremap = true, desc = "pattern" })
map('v', '<leader>hp', '<CMD>HopPattern<CR>', { silent = true, noremap = true, desc = "pattern" })
map('n', '<leader>hs', '<CMD>HopNodes<CR>', { silent = true, noremap = true, desc = "Treesitter symbols" })
map('v', '<leader>hs', '<CMD>HopNodes<CR>', { silent = true, noremap = true, desc = "Treesitter symbols" })
